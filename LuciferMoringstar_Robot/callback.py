...
# # ---------- 🔘 [ | 𝗚𝗥𝗢𝗨𝗣 𝗙𝗜𝗟𝗧𝗘𝗥𝗦 | ] 🔘 ---------- # #
        ...
        if query.data.startswith("nextgroup"):
            ...
            if int(index) == int(data["total"]) - 2:
                ...
                buttons.append(
                    [InlineKeyboardButton(text="File Sended In P", url=f"https://telegram.dog/{bot_info.BOT_USERNAME}")]
                )
...
# ---------- 📁 [ | 𝗠𝗢𝗗𝗨𝗟𝗘𝗦 | ] 📁 ---------- #
            ...
            if query.from_user.id not in ADMINS: 
                buttons = [[
                 ...
                 InlineKeyboardButton("🗳 Deploy", url="https://t.me/MalluHubTG"),
                 InlineKeyboardButton("🤖 Update", url="https://t.me/MalluHubTG")
                 ]]
            else:
                buttons = [[
                 InlineKeyboardButton("➕️ Add me to Your Chat ➕️", url=f"http://t.me/{bot_info.BOT_USERNAME}?startgroup=true")
                 ...
                 InlineKeyboardButton("🗳 Join", url="https://t.me/MalluHubTG"),
                 InlineKeyboardButton("🤖 Update", url="https://t.me/MalluHubTG")
                 ]]               
